...
**Professional Developer Utility Suite** — 5 essential tools, 100% client-side, offline-ready PWA.
...
| 4 | **Password Guard** | Secure generation with entropy meter (uses `crypto.getRandomValues`) |
| 5 | **Model Generator** | JSON → C# classes, Go structs, Python dataclasses, PHP 8.1 DTOs |

## Tech Stack

- **HTML5** + **Tailwind CSS** (Play CDN)
- **Alpine.js** for reactive state management
- **Prism.js** for syntax highlighting (JSON, C#, Go, Python, PHP)
- **Lucide Icons**
